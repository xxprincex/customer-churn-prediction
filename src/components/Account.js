                  ...
                  <div className="lg:w-1/3 p-8 lg:p-12 bg-gradient-to-br from-gray-50/50 via-white/50 to-gray-100/50 backdrop-blur-md border-l border-white/20">
                    ...
                    {subscriptionPlan === "Gold" &&
                      userDetails.subscriptionStatus === "trial" && (
                        <div className="space-y-8">
                          <div className="text-center">
                            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-full text-white font-semibold shadow-lg mb-6">
                              <svg
                        ...
                        <div className="space-y-8">
                          ...
                          <div className="space-y-3">
                            <button
                              ...
                              className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full py-3 px-6 font-semibold transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 flex items-center justify-center gap-2"
                            >
                              <svg
                                className="w-5 h-5"
                                fill="none"
